            ...
            ScrollView {
                VStack(alignment: .leading, spacing: VornSpacing.xl) {
                    ...
                    section(
                        ...
                        ServerCard(name: "🇸🇪 Швеция SE-01", quality: .good, transport: "Vision", onTap: {})
                        ServerCard(name: "🇫🇷 Франция Париж Премиум Скорость", quality: .poor, transport: "XHTTP", onTap: {})
                    }

                    section(title: "Ручные ключи", meta: nil, refresh: false) {
                        ServerCard(name: "🇯🇵 Япония Токио", quality: .fair, transport: "Vision", onTap: {})
                    }
                }
